...
class RisingBambooWoocommerce {
			...
			jQuery( window ).on(
				...
				function ( e ) {
					$galleryElement.find( '.item.act' ).each( function () {
						...
						jQuery( $thumbElement ).slick( 'slickGoTo', $position );
					} );
				}
			);
			jQuery( $thumbElement )
	...
	novAccordion() {
		jQuery( document ).on( 'click', '.nov-accordion__title', function () {
			if ( jQuery( this ).hasClass( 'act' ) ) {
				...
				jQuery( this )
					...
					.slideUp();
				jQuery( '.nov-accordion' ).removeClass( 'active' );
			} else {
				jQuery( this )
				...
				jQuery( this )
					...
					.slideUp();
				jQuery( this ).addClass( 'act' );
				jQuery( '.nov-accordion' ).addClass( 'active' );
				jQuery( this )
					.parent()
					.find( '.nov-accordion__content' )
					.slideDown();
