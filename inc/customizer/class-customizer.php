...
class Customizer extends Singleton {
	...
	public function __construct() {
		...
		// Uncomment if you want to use live preview for blogname, blogdescription.
		/* add_action( 'customize_preview_init', [$this,'customize_preview_js'] ); */ //phpcs:ignore Squiz.PHP.CommentedOutCode.Found
