	...
	public function add_cpt_support(): void {
		...
		if ( ! $cpt_support ) {
			...
			$cpt_support = [
				'page',
				'post',
				FooterPostType::POST_TYPE,
				MegaMenu::POST_TYPE,
				TestimonialPostType::POST_TYPE,
			];
		}
		if ( ! in_array(FooterPostType::POST_TYPE, $cpt_support, true) ) {
			$cpt_support[] = FooterPostType::POST_TYPE;
		}
		if ( ! in_array(MegaMenu::POST_TYPE, $cpt_support, true) ) {
			$cpt_support[] = MegaMenu::POST_TYPE;
		}
		if ( ! in_array(TestimonialPostType::POST_TYPE, $cpt_support, true) ) {
