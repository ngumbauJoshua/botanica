...
class Helper {
	...
	public static function show_wishlist(): bool {
		return RisingBambooCoreHelper::woocommerce_wishlist_activated() && in_array(Setting::get(RISING_BAMBOO_KIRKI_FIELD_LAYOUT_HEADER_WISH_LIST), self::$on, true);
	}
	...
	public static function show_search_product_form(): bool {
		return RisingBambooCoreHelper::woocommerce_activated() && in_array(Setting::get(RISING_BAMBOO_KIRKI_FIELD_LAYOUT_HEADER_SEARCH_FORM), self::$on, true);
	}
	...
	public static function show_mini_cart(): bool {
		return RisingBambooCoreHelper::woocommerce_activated() && in_array(Setting::get(RISING_BAMBOO_KIRKI_FIELD_LAYOUT_HEADER_MINI_CART), self::$on, true);
	}
