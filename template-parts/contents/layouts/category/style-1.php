...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="blog-wrap">
		...
		<div class="-mt-[104px] relative w-[87.5%] bg-white rounded-tr-[28px]">
			<?php
			if ( 'post' === get_post_type() ) :
				?>
				<div class="pt-7 font-semibold text-[#909090] text-[10px] uppercase">
			...
			<div class="entry-content mb-[30px]">
				<h3 class="entry-title text-[18px] pt-5 pb-4"><a href="<?php echo esc_url(the_permalink()); ?>"><?php echo esc_html(the_title()); ?></a></h3>
				...
				<?php } ?>
				<div class="my-5">
					<a href="<?php echo esc_url(the_permalink()); ?>" class="blog_readmore font-semibold relative mt-6 mb-4"><span class="mr-[6px] relative"><?php echo esc_html__('Read more', 'botanica'); ?></span><i class="rbb-icon-direction-711 relative"></i></a>
				</div>
			</div>
			<?php wp_link_pages(); ?>
		</div><!-- .entry-content -->
