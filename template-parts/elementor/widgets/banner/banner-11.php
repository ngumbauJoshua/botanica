...
<div id="<?php echo esc_attr($id); ?>" class="relative overflow-hidden <?php echo esc_attr($layout); ?>">
	<div class="lg:grid relative">
		<div class="lg:mb-0 mb-[30px] mx-auto md:max-w-[460px] absolute left-0 z-10 text-left top-[50%] -translate-y-1/2 lg:px-10 px-[15px]">
			<div class="text-white">
				<div class="title_block font-bold">
					<h4 class="title md:text-[26px] text-base"><?php echo wp_kses_post($title); ?></h4>
					<p class="sub_title pt-0.5 lg:pb-2.5"><?php echo wp_kses_post($sub_title); ?></p>
				</div>
