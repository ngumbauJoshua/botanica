...
<div id="<?php echo esc_attr($id); ?>" class=" relative <?php echo esc_attr($layout); ?>">
	<div class="container mx-auto">
		<div class="grid grid-cols-12 gap-4 py-8">
			<div class="banner-left col-span-12 lg:col-span-6 lg:mt-0 mt-8 wow fadeInLeft" >
				...
				<div class="col-span-12 lg:col-span-6 relative lg:order-1 -order-1 wow fadeInRight">
					<div class="lg:text-left text-center">
						<div class="title_block">
							<p class="sub_title xl:text-4xl text-xl pb-4 mb-0"><?php echo wp_kses_post($sub_title); ?></p>
							<h2 class="title xl:leading-[55px] leading-9"><?php echo wp_kses_post($title); ?></h2>
						</div>
						<?php
						if ( ! empty($countdown) && ( time() < strtotime($countdown) ) ) {
							?>
							<div class="pt-5 pb-2 banner-countdown -mx-[5px] wow fadeInRight">
						...
						?>
						<div class="desc mt-4 text-base"><?php echo wp_kses_post($description); ?></div>
					</div>
					<div class="pt-4">
						<?php
