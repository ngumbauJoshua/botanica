				...
				<div class="content">
					<div class="text-center">
						<div class="title_block wow fadeInUp">
							<p class="sub_title  text-lg pb-2"><?php echo wp_kses_post($sub_title); ?></p>
							<h2 class="title leading-9"><?php echo wp_kses_post($title); ?></h2>
						</div>
						<div class="desc lg:mt-4 text-base leading-6 text-white wow fadeInUp"><?php echo wp_kses_post($description); ?></div>
						<div class="-mx-[15px] pt-7 wow fadeInUp">
							<div class="banner-custom-html md:flex mt-5 md:justify-between">
								<?php
								foreach ( $custom_html as $html ) {
									...
									echo "<div class='custom-html float-left duration-300 text-center min-w-20 pb-[30px] mt-5 md:pt-0 px-[15px] lg:w-1/3 md:w-1/2 w-full inline-block " . esc_attr($repeater_custom_html_class) . ' ' . esc_attr($position) . "'>" . wp_kses_post($html[ $widget->get_name_setting('custom_html') ]) . '</div>';
								}
								?>
							</div>
						</div>
