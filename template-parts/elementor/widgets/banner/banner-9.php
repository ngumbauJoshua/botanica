...
<div id="<?php echo esc_attr($id); ?>" class="relative overflow-hidden rounded-[20px] <?php echo esc_attr($layout); ?>">
	<div class="lg:grid relative">
		<div class="lg:mb-0 mb-[30px] mx-auto md:max-w-[460px] absolute left-0 z-10 text-left top-[50%] -translate-y-1/2 md:px-10 px-[15px]">
			<div class="text-white">
				<div class="title_block font-bold">
					<p class="sub_title text-2xl pb-2 mb-0"><?php echo wp_kses_post($sub_title); ?></p>
					<h4 class="title text-2xl"><?php echo wp_kses_post($title); ?></h4>
				</div>
				<div class="desc text-sm mt-4 leading-[23px]"><?php echo wp_kses_post($description); ?></div>
			</div>
			<?php
