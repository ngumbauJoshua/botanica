...
<div id="<?php echo esc_attr($id); ?>" class=" relative z-10 <?php echo esc_attr($layout); ?>">
	<div class="mx-auto">
		<div class="grid grid-cols-12 gap-0">
			<div class="banner-left col-span-12 lg:col-span-6 lg:mt-0 mt-8">
			...
			<div class="col-span-12 lg:col-span-6 relative xl:px-[90px] px-10 px-[15px] flex items-center lg:max-w-[800px] lg:order-1 -order-1">
				<div class="lg:text-left text-center">
					...
					?>
					<div class="desc mt-4 xl:pb-5 pb-3 text-sm leading-6 wow slideInUp"><?php echo wp_kses_post($description); ?></div>
					<div class="md:flex md:justify-between xl:mt-10 mt-2 wow slideInUp">
						<?php
