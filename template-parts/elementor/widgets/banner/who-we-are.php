...
<div id="<?php echo esc_attr($id); ?>" class="overflow-hidden relative z-10 min-h-[650px] flex items-center <?php echo esc_attr($layout); ?>">
	<div class="mx-auto">
		<div class="grid grid-cols-12 gap-0">
			<div class="banner-left wow fadeInLeft col-span-12 lg:col-span-3 relative flex items-center lg:ml-0 ml-1 lg:md-0 mr-2.5">
				<ul id="tabs" class="w-full">
					<?php
					$i = 0;
					foreach ( $custom_html as $html ) {
						...
						?>
						<li>
							<a href="#tab<?php echo esc_attr($i); ?>" class="custom-html tablinks text-left relative cursor-pointer px-6 py-5 block rounded-[80px] mb-5 <?php echo esc_attr($repeater_custom_html_class . ' ' . $position); ?>">
								<?php echo wp_kses_post($html[ $widget->get_name_setting('custom_html') ]); ?>
							</a>
						</li>
						<?php
						++$i;
			...
			<div class="wow fadeInUp banner-center relative col-span-12 lg:col-span-6 lg:mt-0 mt-8 xl:px-0 md:px-[30px]">
				...
				foreach ( $images as $image ) {
					...
					?>
					<div id="tab<?php echo esc_attr($y); ?>" class="tabcontent">
						<?php
			...
			<div class="wow fadeInRight md:mt-0 mt-10 col-span-12 lg:col-span-3 relative flex items-center">
				<div class="lg:text-left text-center">
					<div class="title_block">
						<p class="sub_title xl:text-4xl text-xl pb-4"><?php echo wp_kses_post($sub_title); ?></p>
						<h4 class="title xl:text-4xl text-2xl text-[#222] xl:leading-[50px] leading-9"><?php echo wp_kses_post($title); ?></h4>
						<?php
					...
					<div class="desc mt-4 xl:pb-8 pb-3 text-base"><?php echo wp_kses_post($description); ?></div>
				</div>
				<div class="pt-7">
					<?php
