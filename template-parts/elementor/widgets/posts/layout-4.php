...
if ( count($posts['posts']) ) {
	...
	<div id="<?php echo esc_attr($id); ?>" class="rbb_posts bg-cover <?php echo esc_attr($layout); ?> pb-[67px]">
		<div class="container mx-auto mt-2">
			<div class="block_slide xl:-mx-7">
				<div class="block_slider__content overflow-hidden xl:px-7">
					<div class="mb-[53px] text-center">
						<span class="sub_title text-lg mb-4 block"><?php echo wp_kses_post($sub_title); ?></span>
						<h2 class="title md:mb-0 mb-[30px] block"><?php echo wp_kses_post($posts['title']); ?></h2>
						<?php
