...
if ( $sliders ) {
	...
	<div id="<?php echo esc_attr($id); ?>" class="rbb-elementor-slider overflow-hidden <?php echo esc_attr($layout_type); ?> <?php echo esc_attr($layout); ?>">
		...
		<div class="container mx-auto px-4 wow fadeInUp" data-wow-delay="0.1s">
			<div class="content-grid grid md:grid-cols-4 md:pt-0 pt-12 lg:grid-cols-5 xl:grid-cols-6 md:gap-4 gap-0 lg:gap-12 items-center relative">
				<div class="block_title z-10 col-span-1 flex md:justify-between justify-center md:block">
					...
					<?php if ( 'true' === $show_arrows ) { ?>
						<div class="slick-arrow-custom arrow-custom duration-300 md:flex hidden md:mt-12">
							<span class="prev_custom mr-4 w-[40px] h-[40px] rounded-full !bg-white flex items-center justify-center cursor-pointer before:!bg-black after:!bg-black"></span>
							<span class="next_custom w-[40px] h-[40px] rounded-full !bg-white flex items-center justify-center cursor-pointer before:!bg-black after:!bg-black"></span>
						</div>
					<?php } ?>
				</div>
				<div class="block_slide md:col-span-3 lg:col-span-4 xl:col-span-5">
					<div class="rbb-slick-carousel slick-carousel slick-carousel-center load-item-<?php echo esc_attr($sliders_to_show_default); ?>" data-slick='{
						...
						foreach ( $sliders as $slider ) {
							...
							?>
							<div class="item md:py-[60px] sm:py-10">
								<div class="block__content duration-300 relative bg-white text-center rounded-[95px] px-3 lg:px-4 pt-4 pb-14 shadow-[5px_5px_10px_rgba(0,0,0,0.15)]">
									<?php if ( $slider[ $slick->get_name_setting('multiple_content_image') ]['url'] ) { ?>
										<img class="mb-5 !rounded-[95px] !inline-block" src="<?php echo esc_url($slider[ $slick->get_name_setting('multiple_content_image') ]['url']); ?>" alt="<?php echo esc_attr($slider[ $slick->get_name_setting('multiple_content_title') ]); ?>">
										<?php
									}
									?>
									...
									<p class="text-center mb-0"><?php echo esc_attr($slider[ $slick->get_name_setting('multiple_content_description') ]); ?></p>
