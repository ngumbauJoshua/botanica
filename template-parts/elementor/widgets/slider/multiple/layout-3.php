...
if ( $sliders ) {
	?>
	<div id="<?php echo esc_attr($id); ?>" class="rbb-elementor-slider overflow-hidden lg:pt-[80px] pt-16 lg:pb-[170px] pb-20 <?php echo esc_attr($layout_type); ?> <?php echo esc_attr($layout); ?>">
		...
		<?php } ?>
		<div class="container mx-auto md:px-[15px] px-2 overflow-hidden">
					...
					<div class="block_slide mt-16">
						...
						foreach ( $sliders as $slider ) {
							...
							<div class="item md:py-[60px] sm:py-10">
								<div class="block__content relative duration-300 text-center px-3 lg:px-4 pt-4">
									<?php if ( $slider[ $slick->get_name_setting('multiple_content_image') ]['url'] ) { ?>
										<div class="content-img p-1.5 relative">
											<div class="overflow-hidden rounded-full">
												<img class="bg-white rounded-full overflow-hidden w-full relative z-10 duration-300" src="<?php echo esc_url($slider[ $slick->get_name_setting('multiple_content_image') ]['url']); ?>" alt="<?php echo esc_attr($slider[ $slick->get_name_setting('multiple_content_title') ]); ?>">
											</div>									
										</div>
									<?php } ?>
									<h4 class="text-base font-bold mt-[35px] pb-2.5">
										<?php
									...
									<p class="text-center text-sm leading-6 mb-0"><?php echo esc_attr($slider[ $slick->get_name_setting('multiple_content_description') ]); ?></p>
