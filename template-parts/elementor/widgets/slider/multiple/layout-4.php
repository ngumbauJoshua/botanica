			...
			<div class="block_title text-center flex justify-center items-center">
				...
				<?php if ( $widget_title || $widget_sub_title ) { ?>
					<div class="title_block inline-block">
						...
						if ( $widget_sub_title ) {
							?>
							<p class="sub-title text-[#222222] text-2xl pb-3"><?php echo esc_html($widget_sub_title); ?></p> <?php } ?>
							<?php
							if ( $widget_title ) {
								?>
								<h4 class="main-title text-[#222222] text-xl"><?php echo esc_html($widget_title); ?></h4> <?php } ?>
							</div>
						<?php } ?>
						<?php if ( 'true' === $show_arrows ) { ?>
							<div class="slick-arrow-custom text-lg text-white">
					...
					<div class="block_slide">
						...
						foreach ( $sliders as $slider ) {
							...
							?>
							<div class="item">
								<div class="block__content relative duration-300 bg-white text-center px-4 pt-5">
									<?php if ( $slider[ $slick->get_name_setting('multiple_content_image') ]['url'] ) { ?>
										<img class="pb-4 !inline-block" src="<?php echo esc_url($slider[ $slick->get_name_setting('multiple_content_image') ]['url']); ?>" alt="<?php echo esc_attr($slider[ $slick->get_name_setting('multiple_content_title') ]); ?>">
									<?php } ?>
