							...
							<div class="swiper-slide">
								<div class="item md:py-[60px] sm:py-10">
									<div class="block__content relative duration-300 text-center rounded-[26px] px-2 md:px-3 lg:px-4 pt-4 pb-5">
										...
										?>
										<p class="text-center leading-[22px] max-w-[260px] mb-0 inline-block font-bold text-[color:var(--rbb-general-primary-color)]"><?php echo esc_attr($slider[ $slick->get_name_setting('multiple_content_description') ]); ?></p>
