				...
				<div class="w-full item elementor-repeater-item-<?php echo esc_attr($slider['_id']); ?>">
					<div class="item-content relative">
						<div class="absolute top-0 w-full h-full">
							<div class="max-w-[1740px] lg:mx-[75px] mx-5 mx-auto <?php echo esc_attr(( $parallax ) ? 'parallax' : ''); ?> relative h-full">
								<?php
								if ( $slider_title || $slider_sub_title || $description || $button_1 || $button_2 ) {
									...
									?>
									<div class="absolute info-wap md:w-1/2 z-50 <?php echo esc_attr($horizontal_align_class); ?> <?php echo esc_attr($vertical_align_class); ?>">
										<div class="info-inner pl-[15px]">
											...
											if ( $description ) {
												...
												<div data-visibility-start="<?php echo esc_attr($description_visibility); ?>"
													...
													class="description truncate md:mb-4 lg:whitespace-normal lg:mb-6 <?php echo esc_attr($description_visibility); ?>"
												>
											...
											<div class="button-group flex items-center">
												...
												if ( $button_1 ) {
													...
													<a <?php echo ( 'url' !== $button_1_type ) ? 'onclick="RisingBambooModal.modal(\'#rbb-modal-button-01-' . esc_attr($slider['_id']) . '\', event)"' : ''; ?>
														...
														class="rbb-slick-button button-1 h-14 px-9 leading-[50px] rounded-full inline-block <?php echo esc_attr($button_1_visibility); ?>"
														<?php
												...
												if ( $button_2 ) {
													...
													<a <?php echo ( 'url' !== $button_2_type ) ? 'onclick="RisingBambooModal.modal(\'#rbb-modal-button-02-' . esc_attr($slider['_id']) . '\', event)"' : ''; ?>
															...
															class="rbb-slick-button button-2 md:ml-2 lg:ml-5 inline-block <?php echo esc_attr($button_2_visibility); ?>"
															<?php
