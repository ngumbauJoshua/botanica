...
if ( $sliders ) {
	?>
	<div class="rbb-elementor-slider overflow-hidden <?php echo esc_attr($layout_type); ?> <?php echo esc_attr($layout); ?>">
		<div class="flex rbb-slick-carousel slick-carousel slick-carousel-center load-item" data-slick='{
			...
			foreach ( $sliders as $slider ) {
				...
				?>
				<div class="w-full xl:pb-[275px] pb-[120px] item elementor-repeater-item-<?php echo esc_attr($slider['_id']); ?>">
						...
						<div class="md:absolute md:py-0 pt-9 pb-6 top-0 w-full h-full">
							<div class="<?php echo esc_attr(( $parallax ) ? 'parallax' : ''); ?> m-auto relative h-full">
								...
								if ( $slider_title || $slider_sub_title || $description || $button_1 || $button_2 ) {
									...
									?>
									<div class="md:absolute info-wap xl:w-[700px] lg:w-[550px] md:w-1/2 z-50 <?php echo esc_attr($horizontal_align_class); ?> <?php echo esc_attr($vertical_align_class); ?>">
										<div class="info-inner lg:px-0 px-4">
											<?php
											...
											if ( $description ) {
												...
												<div data-visibility-start="<?php echo esc_attr($description_visibility); ?>"
													...
													class="description md:mb-4 lg:whitespace-normal lg:mb-6 <?php echo esc_attr($description_visibility); ?>"
												>
											...
											<div class="button-group md:flex items-center md:text-left text-center <?php echo ( 'center' !== $horizontal_align_center ) ? '' : 'justify-center'; ?>">
												...
												if ( $button_1 ) {
													...
													<a <?php echo ( 'url' !== $button_1_type ) ? 'onclick="RisingBambooModal.modal(\'#rbb-modal-button-01-' . esc_attr($slider['_id']) . '\', event)"' : ''; ?>
														...
														class="rbb-slick-button duration-300 button-1 px-9 h-[58px] leading-[58px] rounded-full inline-block <?php echo esc_attr($button_1_visibility); ?>"
														<?php
