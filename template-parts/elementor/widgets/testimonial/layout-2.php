								...
								<div class="border border-[#d3e7e6] rounded-full w-[78px] h-[78px] p-[7px] inline-block overflow-hidden bg-white">
									<div class="rounded-full overflow-hidden">
										...
										if ( has_post_thumbnail($testimonial) ) {
											...
											?>
											<img class="object-cover !w-[62px] !h-[62px]" src="<?php echo esc_url(get_stylesheet_directory_uri() . '/dist/images/default-thumbnail.png'); ?>" alt="<?php echo esc_html__('Default post thumbnail', 'botanica'); ?>" >
										<?php } ?>
									</div>
								</div>
