							...
							<div class="rounded-full w-[70px] h-[70px] inline-block overflow-hidden">
								<div class="rounded-full overflow-hidden">
									...
									if ( has_post_thumbnail($testimonial) ) {
										...
										?>
										<img class="object-cover !w-[70px] !h-[70px]" src="<?php echo esc_url(get_stylesheet_directory_uri() . '/dist/images/default-thumbnail.png'); ?>" alt="<?php echo esc_html__('Default post thumbnail', 'botanica'); ?>" >
									<?php } ?>
								</div>
							</div>
