...
if ( $testimonials ) { ?>
	<div class="container mx-auto">
		<div class="rbb-testimonial overflow-hidden pt-[93px] pb-[135px] -mt-[100px] rounded-tl-lg rounded-tr-lg relative bg-[#e1f3f2] <?php echo esc_attr($layout); ?>">
					...
					<div class="item min-h-[148px] pt-[10px] relative item-<?php echo esc_attr($testimonial->ID); ?> px-[15px]">
						<div class="item-img duration-300 rounded-full w-[70px] h-[70px] inline-block overflow-hidden">
							...
							if ( has_post_thumbnail($testimonial) ) {
								...
								?>
								<img class="object-cover !w-[90px] !h-[90px]" src="<?php echo esc_url(get_stylesheet_directory_uri() . '/dist/images/default-thumbnail.png'); ?>" alt="<?php echo esc_html__('Default post thumbnail', 'botanica'); ?>" >
							<?php } ?>
						</div> 
