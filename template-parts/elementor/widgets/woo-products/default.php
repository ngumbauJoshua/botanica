...
if ( count($data['products']) ) {
	...
	<div id="<?php echo esc_attr($id); ?>" class="rbb_woo_products <?php echo esc_attr($layout); ?>">
		...
		<?php } ?>
		<div class="max-w-[1330px] lg:px-[25px] px-[15px] mx-auto md:mb-20 mb-10 wow fadeInUp overflow-hidden" data-wow-delay="0.1s">
			<div class="sm:flex items-center justify-between items-center md:mb-8 mb-10">
				<div class="title_left md:flex items-center md:text-left text-center">
					<?php if ( $show_title ) { ?>
						...
						if ( '1' < $cat_count || ( $show_filter && '1' === $cat_count ) ) {
							...
							<select class="appearance-none"
									...
									data-ajax='{
										...
										"show_wishlist" : <?php echo esc_attr(( $show_wishlist ) ? 'true' : 'false'); ?>,
										...
										"show_percentage_discount" : <?php echo esc_attr(( $show_percentage_discount ) ? 'true' : 'false'); ?>,
