...
if ( count($data['products']) ) {
	...
	<div id="<?php echo esc_attr($id); ?>" class="rbb_woo_products <?php echo esc_attr($layout); ?>">
		...
		<?php } ?>
		<div class="max-w-[1330px] lg:px-[25px] px-[15px] mx-auto md:pb-20 pb-10 overflow-hidden">
			<div class="text-center mb-6">
				<div class="title_left justify-center items-center overflow-hidden wow fadeInUp">
					<?php if ( $show_title ) { ?>
					<div class="text-white mb-9">
						<h2 class="title font-bold"><?php echo wp_kses_post($data['title']); ?></h2>
