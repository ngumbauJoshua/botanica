				...
				<div class="flex flex-nowrap items-center h-full grid grid-cols-8 md:gap-4">
					<div class="rbb-header-center flex items-center md:col-span-3 col-span-2">
						...
						add_action(
							'wp_footer',
							function () {
								echo '<div class="rbb-menu-canvas rbb-modal">';
									echo '<div class="menu-canvas-left canvas-menu w-[300px] fixed top-0 left-0 bottom-0 p-5 bg-white z-30 overflow-hidden">';
										echo '<div class="search_desktop mt-[30px] mb-9 animate-[500ms] fadeInLeft">';
										...
										echo '<div id="rbb-site-navigation" class="rbb-main-navigation">';
											echo '<div id="menu-main" class="menu primary-menu relative">';
												echo wp_kses_post(Menu::primary_menu());
											echo '</div>';
										echo '</div>';
