...
?>
<header id="rbb-default-header" class="rbb-default-header header-4 lg:absolute w-full z-20">
	<div class="rbb-header-sticky relative md:h-[118px] h-[70px] md:block hidden">
		<div class="header-inner relative mx-auto h-full px-5 xl:px-7 2xl:px-[90px] bg-[color:var(--rbb-header-background-color)]">
