...
?>
<header id="rbb-default-header" class="rbb-default-header header-7 w-full relative z-20">
	<div class="rbb-header-sticky relative md:block hidden bg-[color:var(--rbb-menu-sticky-background-color)]">
		<div class="md:container mx-auto h-full">
			<div class="header-inner mx-auto md:h-[110px] h-[70px]">
			...
			<div id="desktop_menu" class="rbb-header-center lg:flex hidden items-center justify-center h-[70px] rounded-t-[20px] bg-[color:var(--rbb-header-background-color)]">
