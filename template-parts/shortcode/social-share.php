...
if ( $facebook || $twitter || $linkedin || $pinterest || $tumblr || $email ) {
	...
	if ( 'enable' === $config['popup'] ) {
		...
		<div class="rbb-social-share hidden">
			<div class="rbb-social-share-inner p-[25px] md:min-w-[500px] bg-white rounded-lg">
				<div class="copy-link">
					<div class="social-title text-[color:var(--rbb-title-color)] font-bold mb-3"><?php echo esc_html__('Copy link', 'botanica'); ?></div>
				</div>
				<div class="nov-copy flex pb-[15px]">
				...
				<div class="mb-2.5 font-bold share-title text-[color:var(--rbb-title-color)]"><?php echo esc_html__('Share', 'botanica'); ?></div>
