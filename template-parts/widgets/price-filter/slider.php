...
<div class="rbb-price-filter relative pt-[14px]" data-price-gap="<?php echo esc_attr($price_gap); ?>">
	...
	<div class="rbb-price-filter__range-input leading-[15px] mx-[1px] text-[0.625rem] font-semibold relative pb-[30px] mb-7">
		...
		<span class="absolute bottom-0 left-0"><?php echo esc_html(get_woocommerce_currency_symbol()) . esc_attr($min_price); ?></span>
		<span class="absolute bottom-0 right-0"><?php echo esc_html(get_woocommerce_currency_symbol()) . esc_attr($max_price); ?></span>
	</div>
	<div class="rbb-price-filter__input items-center font-medium overflow-hidden text-[0.75rem]">
		<div class="w-full leading-6 h-6 mb-4">
			<span><?php echo esc_html__('Ranger :', 'botanica'); ?></span>
			<span class="inline-flex items-center pl-1"><?php echo esc_html(get_woocommerce_currency_symbol()); ?>
			...
			<span class="inline-flex items-center "><?php echo esc_html(get_woocommerce_currency_symbol()); ?>
