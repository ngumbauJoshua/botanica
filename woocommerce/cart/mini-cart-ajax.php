...
?>
<div id="_desktop_cart" class="rbb-mini-cart relative flex items-center justify-center" data-text_added="<?php echo esc_html__('Product was added to cart successfully!', 'botanica'); ?>">
	<div class="dropdown">
		...
		<div class="mini-cart-content bg-[color:var(--rbb-mini-cart-content-background-color)] z-10 absolute top-full pt-5 xl:-right-[30px] right-0 opacity-0 invisible dropdown-menu transition-all duration-300 transform origin-top-right">
			...
			?>
			<div class="rbb-mini-cart-canvas rbb-modal">
				<div class="cart-right md:w-[370px] w-4/5 fixed top-0 -right-[370px] bottom-0 bg-white z-30">
