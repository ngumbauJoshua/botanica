...
<div class="quick-view-product-wrap <?php echo ( false === $outside ) ? 'outside-modal' : ''; ?>" id="quick-view-product-wrap-<?php echo esc_attr($product->get_id()); ?>" data-modal-animation="<?php echo esc_attr($modal_effect); ?>">
