...
>
	...
	<p class="form-row form-row-first mt-6">
		<input type="text" placeholder="<?php esc_html_e('Username or email*', 'botanica'); ?>" class="input-text rbb-checkout__input w-full text-center rounded mb-2.5 h-12 px-5 border outline-none" name="username" id="username" autocomplete="username" />
	</p>
	<p class="form-row form-row-last">
		<input placeholder="<?php esc_html_e('Password*', 'botanica'); ?>" class="input-text rbb-checkout__input w-full text-center rounded h-12 px-5 border outline-none" type="password" name="password" id="password" autocomplete="current-password" />
	</p>
	<div class="clear"></div>
