...
<div class="ml-auto mr-0">
	<div class="woocommerce-ordering pwb-dropdown dropdown relative">
		<div class="nov-accordion__title flex h-[46px] leading-10 min-w-[165px] rounded-[4px] items-center relative cursor-pointer" data-sortby-filter data-toggle="dropdown">
			<span class="sort-by__label text-xs font-semibold text-[color:var(--rbb-general-link-color)]"><?php esc_attr_e('Shop order', 'botanica'); ?></span>
			<i class="rbb-icon-direction-42 text-[10px] text-[#222] font-bold pl-5 ml-auto mr-0"></i>
		</div>
		<div class="nov-accordion__content bg-white absolute hidden z-10 left-auto right-0 min-w-[250px] pt-4 px-4 rounded-b-[10px] rounded-tl-[10px] -mt-[1px] shadow-[10px_10px_10px_rgba(0,0,0,0.1)] border border-[#e4e4e4]">
